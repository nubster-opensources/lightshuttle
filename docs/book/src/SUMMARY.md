...
- [Manifest reference](reference/manifest/index.md)
  - [project](reference/manifest/project.md)
  - [dashboard](reference/manifest/dashboard.md)
  - [observability](reference/manifest/observability.md)
  - [export](reference/manifest/export.md)
  - [postgres](reference/manifest/postgres.md)
